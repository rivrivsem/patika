...
public class UçakBiletiFiyatı {
   ...
   ==> Kişi "Yolculuk Tipini" gidiş dönüş seçmiş ise bilet fiyatı üzerinden %20 indirim uygulanır.
    ...
    public static void main(String[] args) {
        ...
        double mesafe,ucret=0.10,normalTutar=0,yasINdirimOrani = 1,
                yasIndirimi,indirimliTutar,IndirimOrani,gidisDonusind,toplamTutar;
        int age;
        ...
        gidisDonusind=indirimliTutar*0.20;
        toplamTutar=(indirimliTutar-gidisDonusind)*2;
        //senaryo1:
        normalTutar = mesafe * 0.10;
        if (age<13 && age>=0)
        {
            System.out.println("indirimli tutar :"+(normalTutar*0.50));
        } else if (age > 12 && age < 25) {
            System.out.println("indirimli tutar :"+(normalTutar*0.10));
        } else if (age>64)
        {
            System.out.println("indirimli tutar :"+ (normalTutar*0.30));
        }else if (yolculukTipi.equals(2))
        {
            System.out.println(gidisDonusind);
